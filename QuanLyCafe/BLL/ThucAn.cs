...
namespace QuanLyCafe.BLL
{
    internal class ThucAn
    {
        ...
        public DataTable GetDataThucAn()
        {
            string[] parameters = { };
            string[] values = { };
            return provider.GetData("select * from M3_DON", parameters, values, false);
        }
        ...
        public int ThucAnExecuteNonQuery(string data1, string[] data2, object[] data3, bool isStored)
        {
